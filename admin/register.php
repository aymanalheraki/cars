...
<form method="POST" action="reg_action.php" dir="rtl">
  <div align="center">
    <table border="0" cellpadding="0" style="border-style:dashed; border-width:1px; border-collapse: collapse" width="474" dir="rtl" id="table1" height="454">
      <tr>
		...
		نموذج إدخال صورة لموقع البار</span></font></b></td>
      </tr>
      <tr>
        <td align="right" height="20" width="147">
        <p style="margin-top: 0; margin-bottom: 0">
		<font face="Tahoma" size="2" color="#528ABD"><span lang="ar-sa">&nbsp;رقم 
		التعريف </span></font></td>
      ...
      <tr>
        ...
        &nbsp;</font><span lang="ar-sa"><font size="2">اسم 
        الصورة</font></span></font></p></td>
      ...
      <tr>
        ...
        <span lang="ar-sa">&nbsp;نوع الصورة</span></font></td>
        <td width="260" align="right" height="20">
      ...
      <tr>
        <td align="right" height="20" bgcolor="#F1F5FA" width="147">
        <span lang="ar-sa"><font face="Tahoma" size="2" color="#528ABD">&nbsp;الاسم 
		العربي</font></span></td>
        <td width="260" align="right" height="20" bgcolor="#F1F5FA">
      ...
      <tr>
        <td align="right" height="20" width="147">
        <font color="#528ABD" size="2" face="Tahoma">
        <span lang="ar-sa">&nbsp;</span></font><span lang="ar-sa"><font face="Tahoma" size="2" color="#528ABD">الاسم 
		الإنجليزي</font></span></td>
        <td width="260" align="right" height="20">
      ...
      <tr>
        <td align="right" height="20" bgcolor="#F1F5FA" width="147">
        <p style="margin-top: 0; margin-bottom: 0">
        <font color="#528ABD" size="2" face="Tahoma"><span lang="ar-sa">&nbsp;</span></font><span lang="ar-sa"><font face="Tahoma" size="2" color="#528ABD">تصنيف 
		الصورة العربي</font></span></p>
        </td>
        <td width="260" align="right" height="20" bgcolor="#F1F5FA">
      ...
      <tr>
        <td align="right" height="20" bgcolor="#F1F5FA" width="147">
        <p style="margin-top: 0; margin-bottom: 0">
        <font color="#528ABD" size="2" face="Tahoma"><span lang="ar-sa">&nbsp;مقاس 
		الصورة</span></font></p>
        </td>
        <td width="260" align="right" height="20" bgcolor="#F1F5FA">
      ...
      <tr>
        ...
        <font size="2" color="#528ABD" face="Tahoma">&nbsp;سعر اللوحة</font></span></td>
        <td width="260" align="right" height="20">
      ...
      <tr>
        <td align="right" height="20" bgcolor="#F1F5FA" width="147">
		<span lang="ar-sa">
        <font size="2" color="#528ABD" face="Tahoma">&nbsp;ملاحظات</font></span></td>
        <td width="260" align="right" height="20" bgcolor="#F1F5FA">
      ...
      <tr>
        <td align="right" height="20" bgcolor="#F1F5FA" width="147">
		<span lang="ar-sa">
        <font size="2" color="#528ABD" face="Tahoma">&nbsp;ملاحظات إنجليزي</font></span></td>
        <td width="260" align="right" height="20" bgcolor="#F1F5FA">
  ...
  <input type="reset" value="مسح النموذج" name="B2" class="in1" id="i1"></td>
      </tr>
      </table>
    <p>&nbsp;</div>
</form>
